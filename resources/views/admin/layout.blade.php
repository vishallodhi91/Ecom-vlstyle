                            ...
                            <div class="header-button ">
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="has-sub">
                                            <a style="color:#ffff" href="#"><i class="fas fa-user"></i> Admin<span class="arrow">
                                                <i class="fas fa-angle-down"></i>
                                            </span></a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="{{ asset('admin_assets/images/icon/avatar-01.png') }}"
                                                            alt="John Doe" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">Vishal Lodhi</a>
                                                    </h5>
                                                    <span class="email">vishallodhi91090@gmail.com</span>
                                                </div>
                                            </div>
